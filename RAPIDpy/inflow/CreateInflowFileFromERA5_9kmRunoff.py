...
class CreateInflowFileFromERA5_9kmRunoff(CreateInflowFileFromGriddedRunoff):
    ...
    dims_oi = ['time', 'lon', 'lat']
    vars_oi = ['time', 'lon', 'lat', 'RO']
    runoff_vars = ['RO']
    length_time = {"Hourly": 24}

    def __init__(self):
        """Define the attributes to look for"""
        self.runoff_vars = ['RO']
        super(CreateInflowFileFromERA5_9kmRunoff, self).__init__()
